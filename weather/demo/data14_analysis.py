...
# @Author:老萝卜
# @file:data14_analysis.py
# @Software:%{PRODUICT_NAME}

'''
    摘于CSDN DID 迪《Python爬取天气数据及可视化分析》  https://blog.csdn.net/qq_40181592/article/details/107657685?utm_source=app
    代码主要分为weather.py：对中国天气网进行爬取天气数据并保存csv文件；
    data1_analysis.py：对当天的天气信息进行可视化处理；
    data14_analysis.py：对未来14天的天气信息进行可视化处理。
'''
