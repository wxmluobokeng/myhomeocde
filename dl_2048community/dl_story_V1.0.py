...
def dl_storylist(url,path_type,firtpage):
    ...
    # url_list = html.xpath("//tbody[@style='table-layout:fixed;']/tr[@class='tr3 t_one']/td[@class='tal']/a[@class='subject']/@href")[6:]            #丢掉前5个
    # oprname_list = html.xpath("//tbody[@style='table-layout:fixed;']/tr[@class='tr3 t_one']/td[@class='tal y-style']/a/text()")[14:]            #丢掉前5个
    # # author_list = html.xpath("//tbody[@style='table-layout:fixed;']/tr[@class='tr3 t_one']/td[@class='tal y-style']/a[@class='bl']")[6:]            #丢掉前5个
    # text_list = html.xpath("//tbody[@style='table-layout:fixed;']/tr[@class='tr3 t_one']/td[@class='tal']/a[@class='subject']")[6:]                 #丢掉前5个
    # # text_list = html.xpath("//tr[@class='tr3 t_one']/td[@class='tal y-style']/div[@class='f10 gray']")
