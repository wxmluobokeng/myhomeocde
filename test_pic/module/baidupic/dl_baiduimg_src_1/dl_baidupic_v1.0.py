...
'''
    代码摘至  【python3】爬取百度图片，多线程爬取，自动局部刷新与翻页  作者：teavamc
    https://blog.csdn.net/teavamc/ar  ticle/details/80282623
'''
...
class BaiduImgDownloader(object):
    ...
    def __init__(self, word, dirpath=None, processNum=30):
        ...
        # word是用户输入的关键字
        self.word = word
        self.char_table = {ord(key): ord(value) for key, value in BaiduImgDownloader.char_table.items()}
...
if __name__ == '__main__':
    ...
    down = BaiduImgDownloader(word,"e:\\temp\\pythontest\\pic\\baidu_seach")
